...
interface Props {
  front: React.SVGProps<SVGGElement>;
  back: React.SVGProps<SVGGElement>;
}
  ...
  return (
    <svg className='keycap-svg' viewBox="0 0 545 368" fill="none" xmlns="http://www.w3.org/2000/svg" >
      {back}
        ...
        <path className='hitbox' d="M504.565 3H8V328.174M504.565 3V328.174H8M504.565 3L521 19.4348V344.608H24.4348L8 328.174" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} />
    </svg>
