    ...
    <div className='center'>        
      <svg className='back-button' viewBox="0 0 117 127" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g>
            ...
            <path d="M51.641 37.8649L29.0063 60.8424L51.641 83.82V76.7991L38.647 63.6082L88.3365 60.8424L38.647 58.0766L51.641 44.8858V37.8649Z" fill={primaryColor} stroke={primaryColor} strokeWidth="7"/>
        </g>
        ...
        <g className={isHovered ? 'keycap-back-hover' : 'keycap-back'}>
            ...
            <path d="M51.641 31.8654L29.0063 54.8429L51.641 77.8205V70.7996L38.647 57.6087L88.3365 54.8429L38.647 52.0771L51.641 38.8863V31.8654Z" fill={primaryColor} stroke={primaryColor} strokeWidth="7"/>
