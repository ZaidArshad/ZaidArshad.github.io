  ...
  return (
    <div className='webpage'>
        ...
        <div className='text-area'>
          ...
          <div className='text-img' style={{background:primaryColor}}>
            <div style={{margin:'auto', padding:'20px', width:'30%', background:'red'}}>
            ...
            <img className='img' src="https://user-images.githubusercontent.com/52565263/144075313-7e71d7c7-eb6e-4b89-97ab-e19fe4f694eb.png" style={{background:'blue'}}/>
          </div>
        </div>
    </div>
  )
